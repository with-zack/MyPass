...
var Global_VAR = {
	...
	infoData: [ // 个人信息数据
		{ label: "姓名", value: "林成启" }, 
		{ label: "学号", value: "201920154560" }, 
		{ label: "学院", value: "吴贤铭智能工程学院" }, 
		{ label: "年级", value: "2019级" }, 
	...
	stepBox: [     
		...
		{ "name": "提交", "url": "./外出申请_files/true.png" },
		{ "name": "院级审批", "url": "./外出申请_files/true.png" },
	    { "name": "校级审批", "url": "./外出申请_files/true.png" }
	],
	hoursList: [],           // 小时组
	minutesList: [],         // 分钟组
	sSiteName: "",           // 接站地点
